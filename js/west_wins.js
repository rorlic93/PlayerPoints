var margin = {top: 20, right: 20, bottom: 30, left: 40},
	...
	var svg_west = d3.select(".bar-chart-west").append("svg")
		.attr("width", width + margin.left + margin.right)
		.attr("height", height + margin.top + margin.bottom)
	.append("g")
		.attr("transform", "translate(" + margin.left + "," + margin.top + ")");	

	d3.csv("data/team_stats_W.csv", type, function(error, data) {
	...
	svg_west.append("text")
		...
		.text("Win numbers of Western conference NBA teams");
	
	svg_west.selectAll(".bar")
		.data(data)
	.enter().append("rect")
		.attr("class", "barWest")
